...
const InvoicePreview = ({ id = 'invoice-preview', invoiceData, currencySymbol }) => {
    ...
    // On mobile, scale the A4-width (794px) invoice to fit the viewport
    useEffect(() => {
    ...
    return (
        <div className="invoice-preview-scaler" ref={scalerRef}>
            <div id={id} className="invoice-document" ref={docRef}>
                {/* Header */}
